...
from .register_view import RegisterStaffView
...
urlpatterns = [
    ...
    path('api/v1/user/register', RegisterStaffView.as_view(), name='auth_register'),
    path('api/v1/user/register_agent', RegisterStaffView.as_view(), name='auth_register'),
